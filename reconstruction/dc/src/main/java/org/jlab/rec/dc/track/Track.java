...
public class Track extends Trajectory implements Comparable<Track>{
    ...
    /**
     * @param dir unit direction vector of the track at a point along the
     *            track's trajectory between the last layer of region 3 and the
     *            TOF panel 1b.
     */
    public void set_PostRegion3CrossDir(Point3D dir) {
        _Region3CrossDir = dir;
    }
    /** @return point along the track's trajectory at the HTCC surface sphere. */
    public Point3D get_PreRegion1CrossPoint() {
        return _Region1CrossPoint;
    }
    /**
     * @param point a point along the track's trajectory at the HTCC surface
     *              sphere.
     */
    ...
    /**
     * @return unit direction vector of the track at a point along track
     *         trajectory at the HTCC surface sphere.
     */
    public Point3D get_PreRegion1CrossDir() {
        return _Region1CrossDir;
    }
    /**
     * @param dir unit direction vector of the track at a point along track
     *            trajectory at the HTCC surface sphere.
     */
    ...
    /**
     * @param totPathLen total pathlength of track from vertex to last reference
     *                   point on trajectory (cm).
     */
    public void set_TotPathLen(double totPathLen) {
        _totPathLen = totPathLen;
    }
    /**
     * @return total pathlength of track from vertex to last reference point on
     *         trajectory (cm).
     */
    ...
    /**
     * @param trakOrig track vertex position at the distance of closest approach
     *                 to the beam axis (0,0).
     */
    public void set_Vtx0(Point3D trakOrig) {
        _trakOrig = trakOrig;
    }
    /**
     * @return track vertex position at the distance of closest approach to the
     *         beam axis (0,0).
     */
    ...
    /**
     * @param pOrig track 3-momentum at the distance of closest approach to the
     *              beam axis (0,0).
     */
    ...
    /**
     * @return track 3-momentum at the distance of closest approach to the beam
     *         axis (0,0).
     */
    ...
    /**
     * @param trking string to indicate if the stage of tracking is hit-based or
     *               track-based.
     */
    ...
    /**
     * @return a string to indicate if the stage of tracking is hit-based or
     *         time-based
     */
    ...
    /** @return Kalman fit number of degrees of freedom (NDF) */
    public int get_FitNDF() {
        return _FitNDF;
    }
    /** @param _FitNDF Kalman fit number of degrees of freedom (NDF) */
    ...
    /**
     * @param fitConvergenceStatus fit convergence status: 0 if OK, 1 if the fit
     *                             exits before converging.
     */
    public void set_FitConvergenceStatus(int fitConvergenceStatus) {
        this._fitConvergenceStatus = fitConvergenceStatus;
    }
    /**
     * @return fit convergence status: 0 if OK, 1 if the fit exits before
     *         converging.
     */
    ...
    /**
     * @return the state vector in the tilted sector coordinate system at the
     *         mid-plane between the 2 superlayers in region 1.
     */
    public StateVec get_StateVecAtReg1MiddlePlane() {
        return _StateVecAtReg1MiddlePlane;
    }
    /**
     * @param _StateVecAtReg1MiddlePlane
     *            the state vector in the tilted sector coordinate system at the
     *            mid-plane between the 2 superlayers in region 1.
     */
