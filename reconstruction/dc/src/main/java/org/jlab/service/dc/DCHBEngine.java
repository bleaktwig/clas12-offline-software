...
public class DCHBEngine extends DCEngine {
    ...
    public boolean processDataEvent(DataEvent event) {
        ...
        NoiseReductionParameters parameters = new NoiseReductionParameters(2,
        ...
        List<Track> mistrkcands =
                trkcandFinder.getTrackCands(pcrosslist, dcDetector, Swimmer.getTorScale(), dcSwim);
        ...
        if (trkcands.isEmpty()) {
            // No candidates found. Stop here to save the hits, clusters, segments and crosses.
